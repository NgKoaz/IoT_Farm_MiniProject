...
//        return new BrokerInfo(this.broker,
//                this.username,
//                this.password);
//    }
//
//    public void connect(String broker, String username, String password, String feedPathPrefix, HandleConnectionResult listener){
//        try {
...
//
//            this.pathPrefix = feedPathPrefix;
//            listener.onSuccess();
...
//    }
//
//    public static boolean isAbleToConnect(String broker, String username, @NonNull String password){
//        try {
...
//    }
//
//    public interface HandlePublishingResult{
//        void onSuccess(String topic, String payload);
//        void onFailure(String topic, String payload, String errorMessage);
//    }
//
